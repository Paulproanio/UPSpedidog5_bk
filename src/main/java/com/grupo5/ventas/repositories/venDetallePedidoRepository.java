...
@Repository
public interface venDetallePedidoRepository extends JpaRepository<venDetallePedido, Long> {

	Optional <venDetallePedido> findByIdDetallePedido(Long idDetallePedido);
	
	void deleteByIdDetallePedido(Long idDetallePedido);
